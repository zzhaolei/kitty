...
def conf_parsing(self):
    ...
    opts = p('macos_restore_session quit')
    self.ae(opts.macos_restore_session, 'quit')
    opts = p('macos_restore_session never')
    self.ae(opts.macos_restore_session, 'never')
    p('macos_restore_session always', bad_line_num=1)
